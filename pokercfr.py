    ...
    def cfr_strategy_update(self, root, reachprobs):
        if self.iterations == 0:
            ...
            for hc in root.holecards[root.player]:
                ...
                for i in range(3):
                    self.action_reachprobs[infoset][root.player][i] += reachprobs[root.player][hc] * probs[i]
        ...
        for hc in root.holecards[root.player]:
            ...
            self.action_reachprobs[infoset][root.player] += (probs * reachprobs[root.player][hc])
